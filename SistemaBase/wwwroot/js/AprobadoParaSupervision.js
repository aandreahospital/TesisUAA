...
function addEventListeners() {
    document.querySelector(".btnAbm").addEventListener("click", function () {
        ...
        //const horaDesde = document.querySelector("input[name='HoraDesde']").value;
        //const horaHasta = document.querySelector("input[name='HoraHasta']").value;
        const usuarioJefe = document.querySelector("#usuarioJefe").value;
        ...
        //formData.append("HoraDesde", horaDesde);
        //formData.append("HoraHasta", horaHasta);
        formData.append("NombreUsuario", usuarioJefe);
        formData.append("Usuario", document.querySelector("input[name='Usuario']").value);

        // Realizar la solicitud POST utilizando Axios
        axios({
            method: "post", // Cambiado a POST
            url: "/AprobadosParaSupervision/GenerarPdf",
