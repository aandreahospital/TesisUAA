...
const AbrirOferta = (e) => {
    e.preventDefault();
    axios({
        baseURL: "/BolsaTrabajo/AbrirOferta",
        method: 'Get',
        headers: {
            'Accept': 'application/json',
            'Content-Type': 'application/json',
...
const abrirEditOferta = (id) => {
    ...
    axios({
        baseURL: "/BolsaTrabajo/AbrirEditOferta",
        method: 'Get',
        params: params,
        headers: {
            'Accept': 'application/json',
...
const AddEditOferta = (e) => {
    ...
    formData.append('IdOfertaLaboral', document.getElementById('IdOfertaLaboral').value)
    formData.append('Titulo', document.getElementById('Titulo').value)
    formData.append('Descripcion', document.getElementById('Descripcion').value)
    formData.append('FechaCierre', document.getElementById('FechaCierre').value)
    // formData.append('Adjunto', document.getElementById('Adjunto').value)
    ...
    axios({
        method: "post",
        url: "/BolsaTrabajo/AddEditOferta",
        data: formData,
        headers: {
            "Content-Type": "multipart/form-data",
            'X-Response-View': 'Json'
