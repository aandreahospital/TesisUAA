...
{
    [Authorize]
    public class CorreccionBoletaController : Controller
    {
        private readonly DbvinDbContext _dbContext;
        public CorreccionBoletaController(DbvinDbContext context)
        {
            _dbContext = context;
        }
        // GET: CorreccionBoletaController
        public async Task<IActionResult> Index()
        {
            var operacionSupervisor = (from me in _dbContext.RmMesaEntrada
                                       ...
                                       select new CorreccionBoletasCustom()
                                       {
                                           NroEntrada = me.NumeroEntrada,
                                           Tipo_Solicitud = me.TipoSolicitud,
            ...
            return View(await operacionSupervisor.AsNoTracking().ToListAsync());
        }
    }
}
