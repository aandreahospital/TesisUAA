...
namespace SistemaBase.Controllers
{
    ...
    public class InformeOnlineController : Controller
    {
        private readonly DbvinDbContext _dbContext;
        public InformeOnlineController(DbvinDbContext context)
        {
            _dbContext = context;
        }
        //FILTRO QUE AUTORIZA AL USUARIO PARA ACCEDER AL CONTROLADOR CON EL PERMISO
        [TypeFilter(typeof(AutorizarUsuarioFilter), Arguments = new object[] { "RMINON", "Index", "InformeOnline" })]
        ...
        {
            IQueryable<RmMesaEntradum> queryMesaEntrada = _dbContext.RmMesaEntrada.Where(e => e.FechaEntrada <= parametros.FechaHasta && e.FechaEntrada >= parametros.FechaDesde && e.UsuarioEntrada=="USERONLINE").AsQueryable();
            ...
            //    queryMesaEntrada = queryMesaEntrada.AsQueryable();
            //}
